...
#define UNCHARTED2TONEMAP_WHITEPT 1.35	// Linear White Point Value 1.35
#define UNCHARTED2TONEMAP_EXPOSURE 1.0	// Exposure	1.0

#define lum float3(0.2126f, 0.7152f, 0.0722f) //float3(0.3f, 0.38f, 0.22f) //
